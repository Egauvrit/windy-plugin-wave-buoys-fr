const __pluginConfig =  {
  ...
  "desktopWidth": 600,
  "built": 1720617809311,
  "builtReadable": "2024-07-10T13:23:29.311Z",
...
// transformCode: import { map as map$1 } from '@windy/map';
const { map: map$1 } = W.map;
...
function append_stylesheet(node, style) {
	append$2(/** @type {Document} */ (node).head || node, style);
	return style.sheet;
}
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			attr$1(table, "class", "svelte-16hkarb");
		},
		m(target, anchor) {
...
function create_each_block(ctx) {
	...
	return {
		c() {
			tr = element("tr");
			td0 = element("td");
			td0.textContent = `${/*buoy*/ ctx[6].Date}`;
			t1 = space();
			td1 = element("td");
			td1.textContent = `${/*buoy*/ ctx[6]['H1/3']}`;
			t3 = space();
			td2 = element("td");
			td2.textContent = `${/*buoy*/ ctx[6].Hmax}`;
			t5 = space();
			td3 = element("td");
			td3.textContent = `${/*buoy*/ ctx[6]['Th1/3']}`;
			t7 = space();
			td4 = element("td");
			td4.textContent = `${/*buoy*/ ctx[6].DirPic}`;
			t9 = space();
			td5 = element("td");
			td5.textContent = `${/*buoy*/ ctx[6].EtalPic}`;
			t11 = space();
			td6 = element("td");
			td6.textContent = `${/*buoy*/ ctx[6].TempMer}`;
			t13 = space();
			attr$1(td0, "class", "svelte-16hkarb");
			attr$1(td1, "class", "svelte-16hkarb");
			attr$1(td2, "class", "svelte-16hkarb");
			attr$1(td3, "class", "svelte-16hkarb");
			attr$1(td4, "class", "svelte-16hkarb");
			attr$1(td5, "class", "svelte-16hkarb");
			attr$1(td6, "class", "svelte-16hkarb");
			attr$1(tr, "class", "svelte-16hkarb");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr$1(div0, "class", "plugin__mobile-header");
			attr$1(div1, "class", "plugin__title plugin__title--chevron-back");
			attr$1(p0, "class", "mt-5 mb-20 svelte-16hkarb");
			attr$1(p1, "class", "size-l svelte-16hkarb");
			attr$1(p2, "class", "mt-20 mb-5 svelte-16hkarb");
			attr$1(section, "class", "plugin__content");
		},
		m(target, anchor) {
			...
			append$2(section, p1);
			append$2(section, t8);
			append$2(section, hr0);
			append$2(section, t9);
			if_block.m(section, null);
			append$2(section, t10);
			append$2(section, hr1);
			append$2(section, t11);
			append$2(section, p2);
